...
### Help
For any coursework-related questions you have, please come to office hours. Collaboration on the homework is permitted (and \textbf{strongly encouraged!}) as long as you are collaborating with your peers currently enrolled in a section of Math 116. However, write up your final drafts individually to ensure that you have each fully understood the answer(s).\endnote{Honor Code issues aside, you're doing your education a disservice if you turn in work you have not personally thought through carefully.}  Please check before using resources other than the professors teaching this class, your classmates in any of the sections, or campus tutors.  That is, check before asking other professors, students not currently enrolled in the class, the internet, etc.  Mathematical plagiarism is a subtle business, and it's easy to accidentally plagiarize by copying a solution you've read somewhere else.\endnote{Seriously, though: you can't ``unsee'' someone else's solution.  There are deep and interesting ethical conundra lurking here; Googling unwisely (or at all) may lead you down a path you didn't intend to follow.}\\

### Accessibility
Any student needing academic adjustments or accommodations should speak with one of us during the first two weeks of class as well as Allen Harrison, Assistant Dean of Students for International Students and Accessibility (\href{mailton:aharriso@hamilton.edu}{aharriso@hamilton.edu}; Elihu Root House; x4021).  And, as with all things related to your academic pursuits on the Hill, you are welcome to talk to us if you need some help figuring out how to access the resources available to you.
\\

### Attendance and Honor
It's up to you when to miss class; you may choose not to come because of illness, an athletic event, or a religious observance.  By enrolling in this class, however, you are agreeing to be an engaged student, to have a learner's attitude when you come to class, and to encourage your fellow students to do the same.\endnote{If you wantonly skip classes, aside from missing out on the learning community within the walls of our classroom, you'll penalize yourself by getting lower grades than you otherwise would.  And anyway, although we don't take formal attendance, we \textbf{do} notice if you're not in class.} You are part of a community that believes in the power of the Honor Code to make Hamilton College a great place to be a student and a teacher.  We are \textit{all} bound by the responsibility to actively create and maintain a culture of learning, academic integrity, and personal honor.  We do not take our responsibility lightly; nor should you.
\vfill
